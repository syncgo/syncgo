...
// fakeCert1 / fakeCert2 are throwaway self-signed certs used only to exercise
// the TLS config builder's parsing paths; they carry no secret material.
const (
